...
export default function Dashboard() {
  const [jaimicoins] = useState(30); // Valor das Jaimicoins
  ...
  return (
    <Container>
      ...
      <TopContainer>
        <ActivityHistoryContainer>
          <ActivityTitle>Histórico de atividades</ActivityTitle>
          <ActivityText>
            ...
            <CheckboxContainer>
              {checkboxes.map((checked, index) => (
                <StyledCheckbox
                  ...
                  icon={
                    <CircleOutlinedIcon style={{ fontSize: 28 }} />
                  } /* Unchecked circle */
                  checkedIcon={
                    <CircleIcon style={{ fontSize: 28 }} />
      ...
      <PointsContainer>
        <ActivityTitle>Loja de pontos</ActivityTitle>
        <PointsStoreContainer>
